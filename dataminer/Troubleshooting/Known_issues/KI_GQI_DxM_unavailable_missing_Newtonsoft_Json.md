...
This issue only occurs after direct upgrades from DataMiner 10.5.0 [CU0]/10.5.3/10.5.2 to higher versions. Any subsequent upgrade to a newer version of DataMiner will resolve the issue.
